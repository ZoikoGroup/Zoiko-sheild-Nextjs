...
const bullets = [
  "Organization-level SCC (Security Command Center) stream",
  "Cloud Asset Inventory ingestion for drift calculations",
  "Service Account permission auditing and key rotation proof",
  "GKE (Google Kubernetes Engine) container policy mapping",
];

export default function GcpSection() {
  return (
    <section className="bg-[#f7f5f0] w-full">
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-[40px] items-start mx-auto max-w-[1440px] px-[22px] lg:px-[108px] py-[22px] lg:py-[80px]">
        ...
        >
          <div className="flex flex-col gap-4 items-start w-full">
            ...
            <h2 className="font-hanken font-extrabold leading-[1.08] text-[28px] sm:text-[34px] lg:text-[38px] text-[#0a2029] tracking-[-0.76px] m-0">
              Hierarchical Google Cloud Control
            </h2>
            <p className="font-manrope font-medium leading-[21px] lg:leading-[25px] text-[14px] lg:text-[16.5px] text-[#5b6670] m-0 max-w-[560px]">
              Map compliance states down Google Cloud&apos;s folder and
              organizational tree. Ingest asset logs natively to construct
              absolute lineages.
            </p>
          </div>
        ...
        >
          <div className="relative border border-[rgba(18,59,76,0.1)] h-[240px] sm:h-[420px] lg:h-[520px] w-full lg:w-[560px] rounded-[12px] shadow-[0px_16px_32px_rgba(10,32,41,0.04)] overflow-hidden">
            <Image
              src="/images/cloud-platform-integrations/gcp-visual.webp"
              alt="Google Cloud control visualization"
              fill
