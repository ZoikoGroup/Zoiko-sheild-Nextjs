...
const faqs = [
  ...
  {
    q: "How often is compliance evidence synchronized and verified?",
    a: "We run real-time event ingestion webhooks where available, coupled with a full cryptographic mapping review verified daily.",
  },
];
...
export default function FaqSection() {
  ...
  return (
    <Section alt>
      <SectionHeader eyebrow="Frequently Asked Questions" title="Detailed architecture and integration constraints" />
          ...
          return (
            <Reveal key={f.q} delay={i * 0.05}>
              <div className={cardClass}>
                ...
                <div id={`ei-faq-${i}`} hidden={!open} className="px-6 pb-6">
