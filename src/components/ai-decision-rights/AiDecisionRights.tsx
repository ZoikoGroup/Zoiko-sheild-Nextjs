      ...
      <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-[44px] lg:text-[44px] font-bold text-[#111A1E] leading-[1.1] tracking-tight mb-6">
            Make AI authority explicit before{" "}
            <span className="text-[#C8382C]">consequential use.</span>
          </h1>

          {/* Description Paragraph */}
          <p className="text-[#4A555B] text-base sm:text-lg leading-relaxed mb-8 max-w-xl font-normal">
            Advisory, review-required, approval-required and prohibited actions
            - with policy scope, human authority, revalidation, override and
            fail-closed behavior visible.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-6">
            ...
            >
              View Investigation Assistant
            </a>
          </div>

          {/* Bottom Security/Notice Tag */}
          <div className="flex items-center">
            <span className="text-[10px] tracking-[0.15em] font-mono text-[#C8382C] uppercase font-semibold">
              NO SELF-APPROVAL - AI CANNOT REVIER, APPROVE OR RECLASSIFY ITSELF
            </span>
          </div>
        </motion.div>
        ...
        >
          <div className="relative w-full max-w-[520px] rounded-3xl overflow-hidden shadow-2xl bg-[#0B2732] border border-[#FFFFFF20] p-6 flex flex-col">
            ...
            <div className="relative w-full aspect-[22/10] rounded-2xl overflow-hidden bg-[#121B22] border border-[#232F36] mb-5">
              <Image
                src="/images/decision/1.png"
                alt="Route State Graph"
                fill
            ...
            {/* Route State Label */}
            <div className="mb-2">
              <span className="text-[10px] tracking-[0.15em] font-mono text-[#5FE3C5] uppercase">
                ROUTE STATE
              </span>
            </div>
            ...
            {/* Card Description */}
            <p className="text-[#9BA6AD] text-xs sm:text-sm font-mono leading-relaxed mb-4">
              /platform/ai#decision-rights
            </p>

            {/* Canonical Page info */}
            <div className="pt-3 border-t border-[#FFFFFF10] text-[#9BA6AD] text-xs font-mono">
              Canonical page: /platform/ai
            </div>
          </div>
        </motion.div>
      </div>
